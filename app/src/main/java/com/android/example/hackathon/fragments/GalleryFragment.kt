...
import com.android.example.hackathon.BuildConfig
import com.android.example.hackathon.utils.padWithDisplayCutout
import androidx.appcompat.app.AlertDialog
import androidx.fragment.app.FragmentStatePagerAdapter
import androidx.navigation.Navigation
import androidx.navigation.fragment.navArgs
import com.android.example.hackathon.utils.showImmersive
...
class GalleryFragment internal constructor() : Fragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mediaList.sortByDescending { it.lastModified().toString() }
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        mediaViewPager.addOnPageChangeListener(object : ViewPager.OnPageChangeListener{
            ...
            override fun onPageScrolled(position: Int, positionOffset: Float, positionOffsetPixels: Int) {
                ...
                view.findViewById<TextView>(R.id.imageName).text = mediaList[position].name
            }
        ...
        view.findViewById<TextView>(R.id.imageName).text = mediaList.get(mediaViewPager.currentItem).name
